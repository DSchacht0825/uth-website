      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-10 text-sm">
          ...
          >
            ...
            <span className="hidden sm:inline">(668) 283-6529</span>
            <span className="sm:hidden">Call Us</span>
          </a>

          {/* Center - Email */}
          <a
            href="mailto:info@uthcandles.com"
            className="flex items-center text-gray-700 hover:text-rose-600 transition-colors"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="hidden sm:inline">info@uthcandles.com</span>
